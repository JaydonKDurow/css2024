...
'''Read in the csv file using the Rank column as the index and fix the spaces 
 in the column names '''
#Question 1 - done with variable explorer
...
df2016 = df[df["Year"] == 2016] #Question 4 - read from variable explorer
